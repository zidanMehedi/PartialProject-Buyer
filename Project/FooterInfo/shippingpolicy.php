					...
					<table border="0px" width="100%" cellpadding="0px" cellspacing="0px" bgcolor="#f1f1f1">
						<tr>
							...
							<td align="center" valign="top">
								...
								<a href="../Profile/buyerOrder.php"><font color="black">Your Orders</font></a> <br><br>								<a href="../FooterInfo/howorder.php"><font color="black">How to make an Order</font></a> <br><br>
							</td>
							<td width="10%"></td>
							<td align="center" valign="top">
