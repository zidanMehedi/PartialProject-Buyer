						...
						<tr>
							...
							<td width="35%" bgcolor="#E8EBEC" align="center">
								<table border="0px" width="100%" cellpadding="0px" cellspacing="0px">
									...
									<tr>
										<td>
											<form action="buyerLoginCheck.php" method="post">
												<table border="0px" width="100%" cellpadding="0px" cellspacing="0px">
													<tr>
														<td bgcolor="dodgerblue" height="5px"></td>
													</tr>
													<tr>
														<th height="30%" align="center"><h2><font color="tomato">Sign In</font></h2></th>
													</tr>
													<tr>
														<td align="center">
													...
													<tr>
														<td align="center">
															<input type="password" name="userPass" placeholder="Password"> <br><br><br>
														</td>
													</tr>
													<tr>
